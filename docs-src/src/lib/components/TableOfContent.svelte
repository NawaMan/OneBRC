...
<div class="toc no-print" class:expanded={$isContentVisible}>
	...
	<div class="content">
		<ol>
			...
			<li><a href="./presentation/overview.html"          >Overview</a></li>
			<li><a href="./presentation/overview-2.html"        >Overview (2)</a></li>
			<li><a href="./presentation/results.html"           >Results</a></li>
			<li><a href="./presentation/challenge.html"         >One Billion Row Challenge</a></li>
			<li><a href="./presentation/solution-overview.html" >Solution Overview</a></li>
		</ol>
	</div>
	{/if}
</div>
