 ...
 * </ol>
 */
public class CalculateAverage_nawaman_threeHashes {
    ...
    static class StationName implements Comparable<StationName> {
        ...
        StationName(byte[] nameArray, int nameLength, int nameHash1, int nameHash2, int nameHash3) {
            this.nameArray  = nameArray;
            this.nameLength = nameLength;
            this.hashCode1  = nameHash1;
            this.hashCode2  = nameHash2;
            this.hashCode3  = nameHash3;
        }
    ...
    static record StatisticExtractor(
        ...
        Statistic extract() throws IOException {
            ...
            while (buffer.hasRemaining() && (buffer.position() <= stopPosition)) {
                ...
                var stationName = new StationName(stationNameBuffer.bytes, stationNameBuffer.length, stationNameBuffer.hash1, stationNameBuffer.hash2, stationNameBuffer.hash3);
    ...
    static class StationNameBuffer {
        ...
        void readFrom(ByteBuffer buffer) {
            ...
            while (buffer.hasRemaining()) {
                ...
                nameHash1 = (nameHash1 << 9) - nameHash1 + b;  // nameHash*511 + b
            }
